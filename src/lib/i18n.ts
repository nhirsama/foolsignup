...
const translations: Record<LanguageCode, TranslationCatalog> = {
    ...
    ur: {
        ...
        'language.selectAria': 'زبان منتخب',
        'mode.login.title': 'لاگ ان',
        'mode.login.subtitle': 'اپنی شناخت اور رسائی اجازتوں کا نظم کریں',
        'label.username': 'صارف نام',
        'label.password': 'پاس ورڈ',
        'placeholder.username.login': 'صارف نام درج کریں',
        'placeholder.password': 'پاس ورڈ درج کریں',
        'action.submit': 'جمع کریں',
        'action.switchToRegister': 'اکاؤنٹ نہیں ہے؟ رجسٹر کریں',
        'action.switchToLogin': 'اکاؤنٹ ہے؟ لاگ ان',
        'dashboard.online': 'آن لائن',
        'captcha.cancel': 'منسوخ',
    },
    hi: {
    ...
    ta: {
        ...
        'language.selectAria': 'மொழி தேர்வு',
        'mode.login.title': 'உள்நுழை',
        'mode.login.subtitle': 'உங்கள் அடையாளம் மற்றும் அணுகல் அனுமதிகளை நிர்வகிக்கவும்',
        'label.username': 'பயனர் பெயர்',
        'label.password': 'கடவுச்சொல்',
        'placeholder.username.login': 'பயனர் பெயரை உள்ளிடவும்',
        'placeholder.password': 'கடவுச்சொல்லை உள்ளிடவும்',
        'action.submit': 'சமர்ப்பி',
        'action.switchToRegister': 'கணக்கு இல்லையா? பதிவு செய்',
        'action.switchToLogin': 'கணக்கு உள்ளதா? உள்நுழை',
        'dashboard.online': 'ஆன்லைன்',
        'captcha.cancel': 'ரத்து',
    },
    te: {
        'language.switch': 'భాష',
        'language.selectAria': 'భాష ఎంపిక',
        'mode.login.title': 'లాగిన్',
        ...
        'placeholder.username.login': 'వినియోగదారు పేరును నమోదు చేయండి',
        'placeholder.password': 'పాస్‌వర్డ్‌ను నమోదు చేయండి',
        'action.submit': 'సమర్పించు',
        'action.switchToRegister': 'ఖాతా లేదా? నమోదు అవ్వండి',
        'action.switchToLogin': 'ఖాతా ఉందా? లాగిన్',
        'dashboard.online': 'ఆన్‌లైన్',
        'captcha.cancel': 'రద్దు',
    },
    ml: {
        'language.switch': 'ഭാഷ',
        'language.selectAria': 'ഭാഷ തിരഞ്ഞെടുപ്പ്',
        'mode.login.title': 'ലോഗിന്‍',
        'mode.login.subtitle': 'നിങ്ങളുടെ തിരിച്ചറിയലും പ്രവേശനാനുമതികളും നിയന്ത്രിക്കുക',
        'label.username': 'ഉപയോക്തൃനാമം',
        'label.password': 'പാസ്‌വേഡ്',
        'placeholder.username.login': 'ഉപയോക്തൃനാമം നല്‍കുക',
        'placeholder.password': 'പാസ്‌വേഡ് നല്‍കുക',
        'action.submit': 'സമര്‍പ്പിക്കുക',
        'action.switchToRegister': 'അക്കൗണ്ട് ഇല്ലേ? രജിസ്റ്റര്‍ ചെയ്യുക',
        'action.switchToLogin': 'അക്കൗണ്ട് ഉണ്ടോ? ലോഗിന്‍',
        'dashboard.online': 'ഓണ്‍ലൈന്‍',
        'captcha.cancel': 'റദ്ദാക്കുക',
    },
    kn: {
        'language.switch': 'ಭಾಷೆ',
        'language.selectAria': 'ಭಾಷೆ ಆಯ್ಕೆ',
        'mode.login.title': 'ಲಾಗಿನ್',
        'mode.login.subtitle': 'ನಿಮ್ಮ ಗುರುತು ಮತ್ತು ಪ್ರವೇಶ ಅನುಮತಿಗಳನ್ನು ನಿರ್ವಹಿಸಿ',
        'label.username': 'ಬಳಕೆದಾರ ಹೆಸರು',
        'label.password': 'ಪಾಸ್ವರ್ಡ್',
        'placeholder.username.login': 'ಬಳಕೆದಾರ ಹೆಸರನ್ನು ನಮೂದಿಸಿ',
        'placeholder.password': 'ಪಾಸ್ವರ್ಡ್ ನಮೂದಿಸಿ',
        'action.submit': 'ಸಲ್ಲಿಸಿ',
        'action.switchToRegister': 'ಖಾತೆ ಇಲ್ಲವೇ? ನೋಂದಣಿ ಮಾಡಿ',
        'action.switchToLogin': 'ಖಾತೆ ಇದೆಯೇ? ಲಾಗಿನ್',
        'dashboard.online': 'ಆನ್ಲೈನ್',
        'captcha.cancel': 'ರದ್ದುಮಾಡಿ',
    },
    mr: {
        'language.switch': 'भाषा',
        'language.selectAria': 'भाषा निवड',
        'mode.login.title': 'लॉगिन',
        'mode.login.subtitle': 'आपली ओळख आणि प्रवेश परवानग्या व्यवस्थापित करा',
        'label.username': 'वापरकर्ता नाव',
        'label.password': 'पासवर्ड',
        'placeholder.username.login': 'वापरकर्ता नाव टाका',
        'placeholder.password': 'पासवर्ड टाका',
        'action.submit': 'सबमिट करा',
        'action.switchToRegister': 'खाते नाही? नोंदणी करा',
        'action.switchToLogin': 'खाते आहे? लॉगिन करा',
        'dashboard.online': 'ऑनलाइन',
        'captcha.cancel': 'रद्द करा',
    },
    gu: {
        'language.switch': 'ભાષા',
        'language.selectAria': 'ભાષા પસંદગી',
        'mode.login.title': 'લોગિન',
        'mode.login.subtitle': 'તમારી ઓળખ અને ઍક્સેસ પરવાનગીઓ સંચાલિત કરો',
        'label.username': 'વપરાશકર્તા નામ',
        'label.password': 'પાસવર્ડ',
        'placeholder.username.login': 'વપરાશકર્તા નામ દાખલ કરો',
        'placeholder.password': 'પાસવર્ડ દાખલ કરો',
        'action.submit': 'સબમિટ કરો',
        'action.switchToRegister': 'એકાઉન્ટ નથી? નોંધણી કરો',
        'action.switchToLogin': 'એકાઉન્ટ છે? લોગિન કરો',
        'dashboard.online': 'ઓનલાઇન',
        'captcha.cancel': 'રદ કરો',
    },
    pa: {
        'language.switch': 'ਭਾਸ਼ਾ',
        'language.selectAria': 'ਭਾਸ਼ਾ ਚੋਣ',
        'mode.login.title': 'ਲਾਗਇਨ',
        'mode.login.subtitle': 'ਆਪਣੀ ਪਹਿਚਾਣ ਅਤੇ ਐਕਸੈਸ ਅਨੁਮਤੀਆਂ ਸੰਭਾਲੋ',
        'label.username': 'ਯੂਜ਼ਰ ਨਾਂ',
        'label.password': 'ਪਾਸਵਰਡ',
        'placeholder.username.login': 'ਯੂਜ਼ਰ ਨਾਂ ਦਰਜ ਕਰੋ',
        'placeholder.password': 'ਪਾਸਵਰਡ ਦਰਜ ਕਰੋ',
        'action.submit': 'ਜਮ੍ਹਾ ਕਰੋ',
        'action.switchToRegister': 'ਖਾਤਾ ਨਹੀਂ ਹੈ? ਰਜਿਸਟਰ ਕਰੋ',
        'action.switchToLogin': 'ਖਾਤਾ ਹੈ? ਲਾਗਇਨ ਕਰੋ',
        'dashboard.online': 'ਆਨਲਾਈਨ',
        'captcha.cancel': 'ਰੱਦ ਕਰੋ',
    },
    ne: {
        'language.switch': 'भाषा',
        'language.selectAria': 'भाषा छनोट',
        'mode.login.title': 'लगइन',
        'mode.login.subtitle': 'आफ्नो पहिचान र पहुँच अनुमति व्यवस्थापन गर्नुहोस्',
        'label.username': 'प्रयोगकर्ता नाम',
        'label.password': 'पासवर्ड',
        'placeholder.username.login': 'प्रयोगकर्ता नाम लेख्नुहोस्',
        'placeholder.password': 'पासवर्ड लेख्नुहोस्',
        'action.submit': 'पेश गर्नुहोस्',
        'action.switchToRegister': 'खाता छैन? दर्ता गर्नुहोस्',
        'action.switchToLogin': 'खाता छ? लगइन गर्नुहोस्',
    ...
    si: {
        ...
        'mode.login.title': 'පිවිසුම',
        'mode.login.subtitle': 'ඔබගේ හැඳුනුම සහ ප්‍රවේශ අවසර කළමනාකරණය කරන්න',
        'label.username': 'පරිශීලක නම',
        'label.password': 'මුරපදය',
        'placeholder.username.login': 'පරිශීලක නම ඇතුළත් කරන්න',
        'placeholder.password': 'මුරපදය ඇතුළත් කරන්න',
        'action.submit': 'යවන්න',
        'action.switchToRegister': 'ගිණුමක් නැද්ද? ලියාපදිංචි වන්න',
        'action.switchToLogin': 'ගිණුමක් තිබේද? පිවිසෙන්න',
        'dashboard.online': 'මාර්ගගත',
        'captcha.cancel': 'අවලංගු',
    },
    am: {
        'language.switch': 'ቋንቋ',
        'language.selectAria': 'የቋንቋ ምርጫ',
        'mode.login.title': 'ግባ',
        'mode.login.subtitle': 'ማንነትዎን እና የመዳረሻ ፈቃዶችን ያስተዳድሩ',
        'label.username': 'የተጠቃሚ ስም',
        'label.password': 'የይለፍ ቃል',
        'placeholder.username.login': 'የተጠቃሚ ስም ያስገቡ',
        'placeholder.password': 'የይለፍ ቃል ያስገቡ',
        'action.submit': 'አስገባ',
        'action.switchToRegister': 'መለያ የለዎትም? ይመዝገቡ',
        'action.switchToLogin': 'መለያ አለዎት? ይግቡ',
        'dashboard.online': 'መስመር ላይ',
        'captcha.cancel': 'ይቅር',
    },
    hy: {
        'language.switch': 'Լեզու',
        'language.selectAria': 'Լեզվի ընտրիչ',
        'mode.login.title': 'Մուտք',
        'mode.login.subtitle': 'Կառավարեք ձեր ինքնությունը եւ մուտքի իրավասությունները',
        'label.username': 'Օգտատերի անուն',
        'label.password': 'Գաղտնաբառ',
        'placeholder.username.login': 'Մուտքագրեք օգտատերի անունը',
        'placeholder.password': 'Մուտքագրեք գաղտնաբառը',
        'action.submit': 'Ուղարկել',
        'action.switchToRegister': 'Հաշիվ չունե՞ք։ Գրանցվել',
        'action.switchToLogin': 'Հաշիվ ունե՞ք։ Մուտք',
        'dashboard.online': 'Առցանց',
        'captcha.cancel': 'Չեղարկել',
    },
    ka: {
        'language.switch': 'ენა',
        'language.selectAria': 'ენის არჩევანი',
        'mode.login.title': 'შესვლა',
        'mode.login.subtitle': 'მართეთ თქვენი იდენტობა და წვდომის ნებართვები',
        'label.username': 'მომხმარებლის სახელი',
        'label.password': 'პაროლი',
        'placeholder.username.login': 'შეიყვანეთ მომხმარებლის სახელი',
        'placeholder.password': 'შეიყვანეთ პაროლი',
        'action.submit': 'გაგზავნა',
        'action.switchToRegister': 'ანგარიში არ გაქვთ? რეგისტრაცია',
        'action.switchToLogin': 'ანგარიში გაქვთ? შესვლა',
        'dashboard.online': 'ონლაინ',
        'captcha.cancel': 'გაუქმება',
    },
    mn: {
        'language.switch': 'Хэл',
        'language.selectAria': 'Хэл сонгох',
        'mode.login.title': 'Нэвтрэх',
        'mode.login.subtitle': 'Өөрийн таних тэмдэг ба хандалтын зөвшөөрлийг удирдах',
        'label.username': 'Хэрэглэгчийн нэр',
        'label.password': 'Нууц үг',
        'placeholder.username.login': 'Хэрэглэгчийн нэр оруулна уу',
        'placeholder.password': 'Нууц үг оруулна уу',
        'action.submit': 'Илгээх',
        'action.switchToRegister': 'Бүртгэлгүй юу? Бүртгүүлэх',
        'action.switchToLogin': 'Бүртгэлтэй юу? Нэвтрэх',
        'dashboard.online': 'Онлайн',
        'captcha.cancel': 'Цуцлах',
    },
    kk: {
        'language.switch': 'Тіл',
        'language.selectAria': 'Тіл таңдауы',
        'mode.login.title': 'Кіру',
        'mode.login.subtitle': 'Жеке дерек пен қол жеткізу рұқсаттарын басқарыңыз',
        'label.username': 'Пайдаланушы аты',
        'label.password': 'Құпия сөз',
        'placeholder.username.login': 'Пайдаланушы атын енгізіңіз',
        'placeholder.password': 'Құпия сөзді енгізіңіз',
        'action.submit': 'Жіберу',
        'action.switchToRegister': 'Тіркелгі жоқ па? Тіркелу',
        'action.switchToLogin': 'Тіркелгі бар ма? Кіру',
        'dashboard.online': 'Онлайн',
        'captcha.cancel': 'Бас тарту',
    },
    id: {
    ...
    my: {
        ...
        'language.selectAria': 'ဘာသာစကား ရွေးချယ်မှု',
        'mode.login.title': 'လော့ဂ်အင်',
        'mode.login.subtitle': 'သင်၏အထောက်အထားနှင့် ဝင်ရောက်ခွင့်များကို စီမံပါ',
        'label.username': 'အသုံးပြုသူအမည်',
        'label.password': 'စကားဝှက်',
        'placeholder.username.login': 'အသုံးပြုသူအမည် ထည့်ပါ',
        'placeholder.password': 'စကားဝှက် ထည့်ပါ',
        'action.submit': 'ပို့ရန်',
        'action.switchToRegister': 'အကောင့်မရှိပါ? စာရင်းသွင်းပါ',
        'action.switchToLogin': 'အကောင့်ရှိပါသလား? လော့ဂ်အင်',
        'dashboard.online': 'အွန်လိုင်း',
        'captcha.cancel': 'ပယ်ဖျက်မည်',
    },
    km: {
        'language.switch': 'ភាសា',
        'language.selectAria': 'ជម្រើសភាសា',
        'mode.login.title': 'ចូល',
        'mode.login.subtitle': 'គ្រប់គ្រងអត្តសញ្ញាណ និងសិទ្ធិចូលប្រើរបស់អ្នក',
        'label.username': 'ឈ្មោះអ្នកប្រើ',
        'label.password': 'ពាក្យសម្ងាត់',
        'placeholder.username.login': 'បញ្ចូលឈ្មោះអ្នកប្រើ',
        'placeholder.password': 'បញ្ចូលពាក្យសម្ងាត់',
        'action.submit': 'បញ្ជូន',
        'action.switchToRegister': 'មិនមានគណនី? ចុះឈ្មោះ',
        'action.switchToLogin': 'មានគណនី? ចូល',
    ...
    lo: {
        ...
        'mode.login.title': 'ເຂົ້າລະບົບ',
        'mode.login.subtitle': 'ຈັດການຕົວຕົນ ແລະ ສິດເຂົ້າເຖິງ',
        'label.username': 'ຊື່ຜູ້ໃຊ້',
        'label.password': 'ລະຫັດຜ່ານ',
        'placeholder.username.login': 'ປ້ອນຊື່ຜູ້ໃຊ້',
        'placeholder.password': 'ປ້ອນລະຫັດຜ່ານ',
        'action.submit': 'ສົ່ງ',
        'action.switchToRegister': 'ບໍ່ມີບັນຊີ? ລົງທະບຽນ',
        'action.switchToLogin': 'ມີບັນຊີແລ້ວ? ເຂົ້າລະບົບ',
